      ...
      <div className="flex items-center gap-4">
        ...
        {user && (
          <div className="hidden sm:flex items-center gap-4">
            ...
            <span className="text-gray-600 truncate max-w-[120px] text-xs md:text-sm">{user.email} ({user.role})</span>
            <button
        ...
        {user && menuOpen && (
          <div className="absolute top-16 right-2 bg-white shadow-lg rounded p-4 flex flex-col gap-3 z-50 w-48 sm:hidden animate-fade-in">
            ...
            <span className="text-gray-600 truncate max-w-[120px] text-xs">{user.email} ({user.role})</span>
            <button
